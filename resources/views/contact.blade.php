                                ...
                                <ul class="row gy-4 pt-4">
                                    <li class="col-12">
                                        ...
                                        <div
                                            ...
                                            <em
                                                class="icon text-base fs-5 mb-2 mb-lg-0 me-lg-2 ni ni-call-alt-fill"></em><span>+(33)
                                                780959284</span>
                                        </div>
                                        ...
                                        <div
                                            class="d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-lg-start">
                                            <em
                                                class="icon text-base fs-5 mb-2 mb-lg-0 me-lg-2 ni ni-call-alt-fill"></em><span>+(212)
                                                677740552</span>
                                    ...
                                    <li class="col-12">
                                        ...
                                        <div
                                            class="d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-lg-start">
                                            <em
                                                class="icon text-base fs-5 mb-2 mb-lg-0 me-lg-2 ni ni-mail-fill"></em><span>contact@braingentech.com</span>
                                        </div>
                                    </li>
                                    <li class="col-12">
                                        <h5>Localisation</h5>
                                        <div
                                            class="d-flex flex-column flex-lg-row align-items-center justify-content-center justify-content-lg-start">
                                            <em
                                                class="icon text-base fs-5 mb-2 mb-lg-0 me-lg-2 ni ni-map-pin-fill"></em><span>107
                                                Rue Paul Vaillant Couturier , Alfortville 94140 France</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <form action="{{url("/message")}}" method="post" class="form-submit-init">
                                        ...
                                        <div class="row g-4">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-control-wrap">
                                                        <input type="text" name="user-name"
                                                            class="form-control form-control-lg" placeholder="Votre Prénom"
                                                            />
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-control-wrap">
                                                        <input type="email" name="user-email"
                                                            class="form-control form-control-lg" placeholder="Votre Adresse"
                                                            />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <div class="form-control-wrap">
                                                        <textarea name="user-message" class="form-control form-control-lg" placeholder="Votre message ..." ></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                            ...
                            <div class="col-xl-8 col-xxl-9">
                                <div class="block-text">
                                    ...
                                    <p class="lead mt-3">
                                        ...
                                        BrainGenTech, nous créons des solutions sur mesure, parfaitement adaptées à vos
                                        besoins et défis uniques.

                                        Prêt à propulser votre agence de communication vers de nouveaux sommets ?
                                    </p>
                                    <ul class="btn-list btn-list-inline">
                                        <li>
                                            <a href="{{ url('/contact') }}" class="btn btn-lg btn-primary"><span>Demandez
                                                    une Démo </span><em class="icon ni ni-arrow-long-right"></em></a>
                                        </li>
                                    </ul>
                                    <ul class="list list-row gy-0 gx-3">
                                        <li>
                                            <em class="icon ni ni-check-circle-fill text-success"></em><span>Aucun
                                                engagement</span>
                                        </li>
                                        <li>
                                            <em class="icon ni ni-check-circle-fill text-success"></em><span>Audit
                                                technique</span>
                                        </li>
                                        <li>
                                            <em class="icon ni ni-check-circle-fill text-success"></em><span>Explorer les
                                                differentes automatisations sur mesure
                                            </span>
                                        </li>
                                    </ul>
                                </div>
