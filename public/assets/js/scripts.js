      ...
      a.forEach(t => {
        e.Dropdown.load(t, n),
          t.addEventListener("click", function(s) {
            s.preventDefault(),
              e.Win.width < i && (e.Dropdown.toggle(t, o), e.Dropdown.closeSiblings(t, o, n, r));
          });
      });
    };
    ...
    e.Navbar = {
      show: function(t, a) {
        t.forEach(e => {
          ...
          a.classList.add(s.active),
          e.body.classList.add(s.body);
      ...
      hide: function(t, a) {
        t.forEach(e => {
          ...
          a.classList.remove(s.active),
          e.body.classList.remove(s.body);
      ...
      o.forEach(n => {
        e.Navbar.mobile(t),
          n.addEventListener("click", function(n) {
            n.preventDefault(),
              a.main > e.Win.width && (t.classList.contains(s.active) ? e.Navbar.hide(o, t) : e.Navbar.show(o, t));
          }),
        ...
        e.Navbar.sticky(".nk-header ." + s.root),
        window.addEventListener("scroll", function() {
            ...
            if (o) {
              ...
              a.onreadystatechange = function() {
                if (4 == this.readyState && 200 == this.status) {
                  ...
                  n.classList.add("form-result-show"),
                    (n.style.display = "block"),
                    e ?
                    ((n.innerHTML = e.message),
                      "success" == e.result ?
                      (n.classList.add("form-result-success"),
                        n.classList.remove("form-result-error"),
                        setTimeout(function() {
                          n.style.display = "none";
                        }, 8e3)) :
                      (n.classList.add("form-result-error"),
                        n.classList.remove("form-result-success"))) :
                    (n.classList.remove("form-result-success"),
                      n.classList.add("form-result-error"),
                      (n.innerHTML = "error"));
                }
              };
              a.open("POST", s, !0), a.send(e), t.reset();
            }
          });
        });
    };
    ...
    e.Custom.init = function() {
      e.Navbar.init(),
        ...
        e.CurrentLink(
          ...
          t.classes.item,
          t.classes.sub,
          t.classes.main, [t.classes.active, t.classes.current],
          !0
        );
    };
